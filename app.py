...
st.write("<h1 style='text-align: center;'>Bridging Language Barriers: Exploring Hindi-to-English Speech-to-Speech Translation for Multilingual Communication</h1>", unsafe_allow_html=True)
